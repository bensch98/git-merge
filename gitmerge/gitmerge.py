...
@click.option('--author', '-a', required=True,
              help='Name of the user whose commits of the source repo should be transferred.')
...
@click.option('--dest', '-d', required=True,
              help='Path to the destination repo where the commits should be transferred to.')
@click.option('--company', required=False, default='',
              help='Company name where you worked at for this repo.')
@click.option('--since', '-s', required=False, default='1w',
              help='Consider commits since date, days, month, years ago. Examples: 0y3m1w6d, 3m1w6d, 14d, 1d8w. [DEFAULT = 1w]')
@click.option('--until', '-u', required=False, default='0d',
              help='Consider commits until date, days, month, years ago. Examples: 0y3m1w6d, 3m1w6d, 14d, 1d8w. [DEFAULT = 0d]')
@click.option('--list', '-l', '_list', required=False, is_flag=True,
              help='Only list the commits, instead of committing and pushing them to the mock repo. Red highlighted commits have already been transferred in the past to the specified destination and are automatically ignored.')
@click.option('--columns', '-c', required=False, default=None,
              multiple=True, help='Name column that should be included.')
